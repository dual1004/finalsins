						...
						if(check == 0){
							...
							if(check == 0){
								...
								commentlist.append('<div class="commentOne">'+list.commentList[i].chan_article_content+'<br><input type="button" class="update2" value="수정"/><input type="button" class="delete2" value="삭제"/><input type="hidden" class="hdwriteNo" value="' + writeNo + '"/><input type="hidden" class="hdcommentNo" value="' + list.commentList[i].chan_article_no + '"/></div>');
									...
									<% // TODO Auto-generated method stub %>
									commentlist.append('<input type="hidden" name="commentNo" value="'+list.commentList[i].chan_article_no+'"/><input type="hidden" name="fireId" value="'+list.commentList[i].user_id+'"/><input type="hidden" name="fireNo" value="'+writeNo+'"/><div class="commentOne"><label>'+list.commentList[i].chan_article_content+'</label><br><input type="button" class="doCommentFire" value="신고"/></div>');
								}
							}
							else {
								commentlist.append('<div class="commentOne"><hr><table><tr><td><img src="/sins/resources/file/'+list.commentList[i].user_id+'/'+list.commentList[i].chan_article_filepath+'" style="width: 30px; height: 30px;"></td><td><h5><table><tr><td>'+list.commentList[i].user_id+'<td></tr><tr><td>'+list.commentList[i].comment_date+'</td></tr></table></h5></td></tr></table><br></div>');
								...
								commentlist.append('<div class="commentOne">'+list.commentList[i].chan_article_content+'<br><input type="button" class="update2" value="수정"/><input type="button" class="delete2" value="삭제"/><input type="hidden" class="hdwriteNo" value="' + writeNo + '"/><input type="hidden" class="hdcommentNo" value="' + list.commentList[i].chan_article_no + '"/></div>');
									...
									<% // TODO Auto-generated method stub %>
									commentlist.append('<input type="hidden" name="commentNo" value="'+list.commentList[i].chan_article_no+'"/><input type="hidden" name="fireId" value="'+list.commentList[i].user_id+'"/><input type="hidden" name="fireNo" value="'+writeNo+'"/><div class="commentOne">'+list.commentList[i].chan_article_content+'<br><input type="button" class="unCommentFire" value="신고취소"/></div>');
								}
							}
							}if(classI == 'GROUP_MAIN'){
								if(check == 0){
        	...
        	$.ajax({
				...
				,success : function(list) {
					...
					for(var i = 0; i < list.commentList.length; i ++) {
						...
						if(classI == 'MY_PAGE'){
						if(check == 0){
							thisdiv.append('<div class="commentOne"><hr><table><tr><td><img src="'+list.commentList[i].userprofile+'" style="width: 30px; height: 30px;"></td><td><h5><table><tr><td>'+list.commentList[i].username+'<td></tr><tr><td>'+list.commentList[i].commentdate+'</td></tr></table></h5></td></tr></table><br></div>');
							if(list.commentList[i].userid == userId){
							...
							if(check == 0){
								thisdiv.append('<div class="commentOne"><hr><table><tr><td><img src="'+list.commentList[i].userprofile+'" style="width: 30px; height: 30px;"></td><td><h5><table><tr><td>'+list.commentList[i].user_id+'<td></tr><tr><td>'+list.commentList[i].comment_date+'</td></tr></table></h5></td></tr></table><br></div>');
								if(list.commentList[i].userid == userId){
									thisdiv.append('<div class="commentOne">'+list.commentList[i].chan_article_content+'<br><input type="button" class="update2" value="수정"/><input type="button" class="delete2" value="삭제"/><input type="hidden" class="hdwriteNo" value="' + writeNo + '"/><input type="hidden" class="hdcommentNo" value="' + list.commentList[i].chan_article_no + '"/></div>');
								}else{
									<% // TODO Auto-generated method stub %>
									thisdiv.append('<input type="hidden" name="commentNo" value="'+list.commentList[i].chan_article_no+'"/><input type="hidden" name="fireId" value="'+list.commentList[i].user_id+'"/><input type="hidden" name="fireNo" value="'+writeNo+'"/><div class="commentOne"><label>'+list.commentList[i].chan_article_content+'</label><br><input type="button" class="doCommentFire" value="신고"/></div>');
								}
							}
							else {
								thisdiv.append('<div class="commentOne"><hr><table><tr><td><img src="'+list.commentList[i].userprofile+'" style="width: 30px; height: 30px;"></td><td><h5><table><tr><td>'+list.commentList[i].user_id+'<td></tr><tr><td>'+list.commentList[i].comment_date+'</td></tr></table></h5></td></tr></table><br></div>');
								if(list.commentList[i].userid == userId){
									...
									<% // TODO Auto-generated method stub %>
									thisdiv.append('<input type="hidden" name="commentNo" value="'+list.commentList[i].chan_article_no+'"/><input type="hidden" name="fireId" value="'+list.commentList[i].user_id+'"/><input type="hidden" name="fireNo" value="'+writeNo+'"/><div class="commentOne">'+list.commentList[i].chan_article_content+'<br><input type="button" class="unCommentFire" value="신고취소"/></div>');
								}
							}
							}if(classI == 'GROUP_MAIN'){
								if(check == 0){
...
<div id="mask"></div>
	...
	<div id="header">
   	...
   	<div id="container">
		...
		<div id="content">
			<div id="add"><img src="/sins/resources/images/11149_105_2.jpg" style="width:100%; height:100%;"></div>
