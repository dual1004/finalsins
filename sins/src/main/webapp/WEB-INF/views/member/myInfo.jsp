	...
	<div id="container">
		<div id="left" class="box">
			...
			<img src="${pageContext.request.contextPath}/resources/file/${loginUser.userId}/${loginUser.userProfile}"
					style="width: 120px;">
			<input type="button" onclick="prodivshow()" value="프로필수정"/>
			<script type="text/javascript">
			function prodivshow(){
				$('#profilechange').show();
			}
			...
			<div id="profilechange" style="width:150px; height: 60px; border: 1px solid black; background: white; display: none;">
