...
$(function() {
	...
	$(document).on("click", ".commentSubmit", function(){
	    	...
	    	$.ajax({
				...
				,success : function(data) {
					if(data == 1){
						thisdiv.append($('<li>', {html : user_id+" : "+content}));
						thisdiv.append('<input type="button" value="삭제" class="commentdel"/><input type="button" value="신고" class="commentFire" />');
					}
				}
			});
	    }); 
...
<div class="updateWindow window">
	...
	<div id="header">
		<div id="overlay_t"></div>channelPage
		<div id="t-l"></div>
		<div id="top"></div>
		<div id="t-r"></div>
	</div>
	<div id="container">
		...
		<div id="channelInfo"> 채널 정보: ${channelPage.channel_info}</div>
